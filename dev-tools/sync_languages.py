            ...
            for key, value in en_data.items():
                ...
                if key in lang_data:
                    ...
                    if isinstance(value, dict) and isinstance(lang_data[key], dict):
                        result[key] = self.merge_structures(
                            value, lang_data[key], lang_code, current_path
                        )
                    else:
                    ...
                    if isinstance(value, dict):
                        ...
                        print(
                            f"  + Added {current_path}: '{translated}' (auto-translated from '{value}')"
                        )
        ...
        for key, value in lang_data.items():
            ...
            if key in en_data:
                if isinstance(value, dict) and isinstance(en_data[key], dict):
                    result[key] = self.remove_extra_keys(
                        en_data[key], value, current_path
                    )
                else:
                    result[key] = value
            else:
